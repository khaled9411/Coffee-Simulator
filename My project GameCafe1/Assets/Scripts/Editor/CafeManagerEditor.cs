...
//            SerializedProperty airConditionsProperty = element.FindPropertyRelative("airConditions");
//            EditorGUI.PropertyField(
//                new Rect(rect.x, rect.y + EditorGUIUtility.singleLineHeight + 100, rect.width, EditorGUI.GetPropertyHeight(airConditionsProperty)),
//                airConditionsProperty,
//                new GUIContent("airConditions"),
//                true
//            );

//            SerializedProperty postersProperty = element.FindPropertyRelative("posters");
//            EditorGUI.PropertyField(
//                new Rect(rect.x, rect.y + EditorGUIUtility.singleLineHeight + 200, rect.width, EditorGUI.GetPropertyHeight(postersProperty)),
//                postersProperty,
//                new GUIContent("posters"),
//                true
//            );
