...
namespace DistantLands.Cozy
{
    ...
    public class BlocksModule : CozyModule, ICozyBiomeModule
    {
        ...
        public override void InitializeModule()
        {
            ...
            biomes = FindObjectsOfType<BlocksModule>().Where(x => x != this).ToList();
        ...
        {
            weatherSphere.GetModule<BlocksModule>().biomes = FindObjectsOfType<BlocksModule>().Where(x => x != weatherSphere.GetModule<BlocksModule>()).ToList();
        }
